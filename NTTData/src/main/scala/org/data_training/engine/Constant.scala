...
trait Constant {
  val JobsList : List[String] = List("Customers","Hdfs_into_postgres","LoadDataToDW","CustomerMasterData","TestLogs")
  ...
  val spark_master: String="spark://spark-master-0.spark-headless.spark1.svc.cluster.local:7077"
