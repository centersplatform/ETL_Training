...
trait WriteDFs extends Constant {
  ...
  def write_df_to_postgresql(df: DataFrame, database: String, table_name: String, mode: String="append", max_pool_size: Int=10, batch_size: Int=1000, num_partition: Int=10): Unit
}
